...
import com.tikal.movies.view.mvp.presenter.MovieDetailPresenter;
...
import com.tikal.movies.view.ui.activity.MovieImagesActivity;
...
public class MovieDetailFragment extends BaseFragment implements MovieDetailView {
    ...
    public void updateBackground(String value) {
        App.PICASSO.load(value).into(coverImage, new Callback() {
            @Override
